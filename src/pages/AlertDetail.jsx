...
export default function AlertDetail({ alert, onBack }) {
  ...
  function handleExport() {
    alert("Demo alert report export started.");
  }
    ...
    <section>
        ...
        <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-start">
          <div>
            ...
            <div className="mt-5 grid gap-3 text-sm text-slate-300 sm:grid-cols-2">
              <p>
                <span className="text-slate-500">Affected Page:</span>{" "}
      ...
      <div className="mt-6 rounded-2xl border border-slate-800 bg-slate-900 p-6">
        <div className="mb-4 flex items-center gap-3">
          ...
          <h3 className="text-lg font-bold text-white">What is Formjacking?</h3>
        </div>
        ...
        <div className="mt-5 rounded-xl border border-red-500/30 bg-red-500/5 p-4">
          <h4 className="font-semibold text-white">Data at Risk</h4>
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-2">
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
          <h3 className="text-lg font-bold text-white">Related Frameworks</h3>

          <div className="mt-4 flex flex-wrap gap-3">
            {["PCI DSS 4.0.1", "GDPR", "CCPA/CPRA"].map((framework) => (
              <span
                key={framework}
                className="rounded-full border border-cyan-500/30 bg-cyan-500/10 px-3 py-1 text-sm font-semibold text-cyan-300"
              >
                {framework}
              </span>
            ))}
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl border border-slate-700 px-5 py-3 text-sm font-semibold text-white hover:bg-slate-800"
        >
          <FileDown size={18} />
          Export Alert Report
        </button>
