...
export default function Sidebar({ activePage, setActivePage }) {
  ...
  return (
    <aside className="hidden min-h-screen w-64 border-r border-slate-800 bg-slate-900/80 p-4 transition-colors duration-300 md:block light:border-slate-200 light:bg-white">
