const statusStyles = {
  ...
  "Action Needed": "border-red-500/40 bg-red-500/10 text-red-400",
};
    ...
    <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
      ...
      <div className="mt-5 space-y-3 text-sm">
        <div className="flex justify-between">
          ...
          <span
            className={
              framework.openIssues > 0 ? "text-red-400" : "text-emerald-400"
            }
          >
        ...
        <div className="flex justify-between">
          ...
          <span className="text-white">{framework.lastScan}</span>
        </div>
      </div>
    </div>
  );
